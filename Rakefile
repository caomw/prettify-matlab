...
SOURCES = %w[lang-matlab.css lang-matlab.js prettify-matlab.user.js switch-lang.user.js prettify-mathworks-answers.user.js prettify-mathworks-fileexchange.user.js]
